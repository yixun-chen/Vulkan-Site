...
value of the `size` member of [VkDeviceAddressRangeEXT](VkDeviceAddressRangeEXT.html) for
binding sampler heaps, including the reservation, when embedded samplers
are used.

* 
 `maxResourceHeapSize` describes
maximum value of the `size` member of [VkDeviceAddressRangeEXT](VkDeviceAddressRangeEXT.html)
