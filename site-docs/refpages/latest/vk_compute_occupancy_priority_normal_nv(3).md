# VK_COMPUTE_OCCUPANCY_PRIORITY_NORMAL_NV(3)

## Metadata

- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/VK_COMPUTE_OCCUPANCY_PRIORITY_NORMAL_NV.html
...
[VK_NV_compute_occupancy_priority](VK_NV_compute_occupancy_priority.html)

For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/dispatch.html#VK_COMPUTE_OCCUPANCY_PRIORITY_NORMAL_NV).
