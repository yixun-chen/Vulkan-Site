...
- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/VK_MAX_VIDEO_VP9_REFERENCES_PER_FRAME_KHR.html
...
[VK_KHR_video_decode_vp9](VK_KHR_video_decode_vp9.html)

For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/videocoding.html#VK_MAX_VIDEO_VP9_REFERENCES_PER_FRAME_KHR).
