...
`VK_FORMAT_UNDEFINED` is allowed with a non-[VK_NULL_HANDLE](VK_NULL_HANDLE.html)
...
than `VK_FORMAT_UNDEFINED` is allowed with a [VK_NULL_HANDLE](VK_NULL_HANDLE.html)
