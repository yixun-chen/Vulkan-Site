...
- **Component**: spec
- **Version**: latest
- **URL**: /spec/latest/chapters/preamble.html
...
The ratified version of the Vulkan Specification can be found at [https://registry.khronos.org/vulkan/specs/latest-ratified/pdf/vkspec.pdf](https://registry.khronos.org/vulkan/specs/latest-ratified/pdf/vkspec.pdf)
...
the Scope of this Specification. The [Document Conventions](introduction.html#introduction-conventions) section of
the [Introduction](introduction.html#introduction) defines how these parts of the Specification are
identified.

Where this Specification uses [technical terminology](introduction.html#introduction-technical-terminology), defined in the [Glossary](../appendices/glossary.html#glossary) or otherwise,
...
[normative](introduction.html#introduction-normative-references)
