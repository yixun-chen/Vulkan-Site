...
[VkTexelBufferDescriptorInfoEXT](#VkTexelBufferDescriptorInfoEXT) or [VkDeviceAddressRangeEXT](fundamentals.html#VkDeviceAddressRangeEXT)
structure on the same [VkDevice](devsandqueues.html#VkDevice) will always return the same bit
pattern.
If the [descriptorHeapCaptureReplay](features.html#features-descriptorHeapCaptureReplay)
...
* 
`pAddressRange` is a pointer to a [VkDeviceAddressRangeEXT](fundamentals.html#VkDeviceAddressRangeEXT)
structure.
...
* 
`heapRange` is a [VkDeviceAddressRangeEXT](fundamentals.html#VkDeviceAddressRangeEXT) defining the device
