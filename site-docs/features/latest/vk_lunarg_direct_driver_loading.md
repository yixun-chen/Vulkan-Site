...
- [5. Issues](#_issues)
- [5.1. RESOLVED: Global functions are not extensible](#_resolved_global_functions_are_not_extensible)
- [5.1._RESOLVED:_Global_functions_are_not_extensible](#_resolved_global_functions_are_not_extensible)
- [5.2. RESOLVED: Should this extension also handle layer loading?](#_resolved_should_this_extension_also_handle_layer_loading)
- [5.2._RESOLVED:_Should_this_extension_also_handle_layer_loading?](#_resolved_should_this_extension_also_handle_layer_loading)
- [5.3. RESOLVED: Do drivers implement this extension?](#_resolved_do_drivers_implement_this_extension)
- [5.3._RESOLVED:_Do_drivers_implement_this_extension?](#_resolved_do_drivers_implement_this_extension)
- [5.4. RESOLVED: Are there any changes drivers need to make to allow being used in this extension?](#_resolved_are_there_any_changes_drivers_need_to_make_to_allow_being_used_in_this_extension)
- [5.4._RESOLVED:_Are_there_any_changes_drivers_need_to_make_to_allow_being_used_in_this_extension?](#_resolved_are_there_any_changes_drivers_need_to_make_to_allow_being_used_in_this_extension)
- [5.5. RESOLVED: What kinds of drivers are expected to be used with this extension?](#_resolved_what_kinds_of_drivers_are_expected_to_be_used_with_this_extension)
- [5.5._RESOLVED:_What_kinds_of_drivers_are_expected_to_be_used_with_this_extension?](#_resolved_what_kinds_of_drivers_are_expected_to_be_used_with_this_extension)
