...
- [5.3. RESOLVED: What type of VP9 parameter sets do we want to store in video session parameters objects?](#_resolved_what_type_of_vp9_parameter_sets_do_we_want_to_store_in_video_session_parameters_objects)
- [5.3._RESOLVED:_What_type_of_VP9_parameter_sets_do_we_want_to_store_in_video_session_parameters_objects?](#_resolved_what_type_of_vp9_parameter_sets_do_we_want_to_store_in_video_session_parameters_objects)
- [5.4. RESOLVED: What should be the contents of the input bitstream buffer when decoding an VP9 frame?](#_resolved_what_should_be_the_contents_of_the_input_bitstream_buffer_when_decoding_an_vp9_frame)
- [5.4._RESOLVED:_What_should_be_the_contents_of_the_input_bitstream_buffer_when_decoding_an_VP9_frame?](#_resolved_what_should_be_the_contents_of_the_input_bitstream_buffer_when_decoding_an_vp9_frame)
...
- [5.6. RESOLVED: Does the application also need to specify the offset of the frame header?](#_resolved_does_the_application_also_need_to_specify_the_offset_of_the_frame_header)
- [5.6._RESOLVED:_Does_the_application_also_need_to_specify_the_offset_of_the_frame_header?](#_resolved_does_the_application_also_need_to_specify_the_offset_of_the_frame_header)
- [5.7. RESOLVED: How do VP9 references map to DPB slot indices?](#_resolved_how_do_vp9_references_map_to_dpb_slot_indices)
- [5.7._RESOLVED:_How_do_VP9_references_map_to_DPB_slot_indices?](#_resolved_how_do_vp9_references_map_to_dpb_slot_indices)
- [5.8. RESOLVED: Does the application has to send frames that have show_existing_frame set for decoding?](#_resolved_does_the_application_has_to_send_frames_that_have_show_existing_frame_set_for_decoding)
- [5.8._RESOLVED:_Does_the_application_has_to_send_frames_that_have_show_existing_frame_set_for_decoding?](#_resolved_does_the_application_has_to_send_frames_that_have_show_existing_frame_set_for_decoding)
...
- [5.9._RESOLVED:_Are_any_of_the_frame_width_minus_1,_frame_height_minus_1,_render_width_minus_1,_and_render_height_minus_1_parameters_from_the_frame_header_redundant_with_respect_to_the_decoded_frame_size_specified_in_VkVideoDecodeInfoKHR::dstPictureResource.codedExtent?](#_resolved_are_any_of_the_frame_width_minus_1_frame_height_minus_1_render_width_minus_1_and_render_height_minus_1_parameters_from_the_frame_header_redundant_with_respect_to_the_decoded_frame_size_specified_in_vkvideodecodeinfokhrdstpictureresource_codedextent)
- [5.10. RESOLVED: What codec-specific parameters need to be specified for the active reference pictures?](#_resolved_what_codec_specific_parameters_need_to_be_specified_for_the_active_reference_pictures)
- [5.10._RESOLVED:_What_codec-specific_parameters_need_to_be_specified_for_the_active_reference_pictures?](#_resolved_what_codec_specific_parameters_need_to_be_specified_for_the_active_reference_pictures)
- [5.11. RESOLVED: How is reference picture setup requested for VP9 decode operations?](#_resolved_how_is_reference_picture_setup_requested_for_vp9_decode_operations)
- [5.11._RESOLVED:_How_is_reference_picture_setup_requested_for_VP9_decode_operations?](#_resolved_how_is_reference_picture_setup_requested_for_vp9_decode_operations)
