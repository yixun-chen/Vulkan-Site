...
- [5.4. RESOLVED: Are interlaced frames supported?](#_resolved_are_interlaced_frames_supported)
- [5.4._RESOLVED:_Are_interlaced_frames_supported?](#_resolved_are_interlaced_frames_supported)
- [5.5. RESOLVED: Do we want to allow the application to specify separate reference lists for each slice?](#_resolved_do_we_want_to_allow_the_application_to_specify_separate_reference_lists_for_each_slice)
- [5.5._RESOLVED:_Do_we_want_to_allow_the_application_to_specify_separate_reference_lists_for_each_slice?](#_resolved_do_we_want_to_allow_the_application_to_specify_separate_reference_lists_for_each_slice)
- [5.6. RESOLVED: Are prefix NAL units generated by the implementation when multiple temporal layers are used?](#_resolved_are_prefix_nal_units_generated_by_the_implementation_when_multiple_temporal_layers_are_used)
- [5.6._RESOLVED:_Are_prefix_NAL_units_generated_by_the_implementation_when_multiple_temporal_layers_are_used?](#_resolved_are_prefix_nal_units_generated_by_the_implementation_when_multiple_temporal_layers_are_used)
- [5.7. RESOLVED: What codec-specific parameters are guaranteed to not be overridden by implementations?](#_resolved_what_codec_specific_parameters_are_guaranteed_to_not_be_overridden_by_implementations)
- [5.7._RESOLVED:_What_codec-specific_parameters_are_guaranteed_to_not_be_overridden_by_implementations?](#_resolved_what_codec_specific_parameters_are_guaranteed_to_not_be_overridden_by_implementations)
- [5.8. RESOLVED: How is reference picture setup requested for H.264 encode operations?](#_resolved_how_is_reference_picture_setup_requested_for_h_264_encode_operations)
- [5.8._RESOLVED:_How_is_reference_picture_setup_requested_for_H.264_encode_operations?](#_resolved_how_is_reference_picture_setup_requested_for_h_264_encode_operations)
