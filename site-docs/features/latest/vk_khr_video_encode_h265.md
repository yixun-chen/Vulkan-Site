...
- [5.3. RESOLVED: What are the requirements for the codec-specific input parameters?](#_resolved_what_are_the_requirements_for_the_codec_specific_input_parameters)
- [5.3._RESOLVED:_What_are_the_requirements_for_the_codec-specific_input_parameters?](#_resolved_what_are_the_requirements_for_the_codec_specific_input_parameters)
- [5.4. RESOLVED: Do we want to allow the application to specify separate reference lists for each slice segment?](#_resolved_do_we_want_to_allow_the_application_to_specify_separate_reference_lists_for_each_slice_segment)
- [5.4._RESOLVED:_Do_we_want_to_allow_the_application_to_specify_separate_reference_lists_for_each_slice_segment?](#_resolved_do_we_want_to_allow_the_application_to_specify_separate_reference_lists_for_each_slice_segment)
- [5.5. RESOLVED: Are generalized P and B frames (aka low delay B frames) supported?](#_resolved_are_generalized_p_and_b_frames_aka_low_delay_b_frames_supported)
- [5.5._RESOLVED:_Are_generalized_P_and_B_frames_(aka_low_delay_B_frames)_supported?](#_resolved_are_generalized_p_and_b_frames_aka_low_delay_b_frames_supported)
- [5.6. RESOLVED: What codec-specific parameters are guaranteed to not be overridden by implementations?](#_resolved_what_codec_specific_parameters_are_guaranteed_to_not_be_overridden_by_implementations)
- [5.6._RESOLVED:_What_codec-specific_parameters_are_guaranteed_to_not_be_overridden_by_implementations?](#_resolved_what_codec_specific_parameters_are_guaranteed_to_not_be_overridden_by_implementations)
- [5.7. RESOLVED: Can implementations override the values of pic_width_in_luma_samples and/or pic_height_in_luma_samples?](#_resolved_can_implementations_override_the_values_of_pic_width_in_luma_samples_andor_pic_height_in_luma_samples)
- [5.7._RESOLVED:_Can_implementations_override_the_values_of_pic_width_in_luma_samples_and/or_pic_height_in_luma_samples?](#_resolved_can_implementations_override_the_values_of_pic_width_in_luma_samples_andor_pic_height_in_luma_samples)
- [5.8. RESOLVED: How is reference picture setup requested for H.265 encode operations?](#_resolved_how_is_reference_picture_setup_requested_for_h_265_encode_operations)
- [5.8._RESOLVED:_How_is_reference_picture_setup_requested_for_H.265_encode_operations?](#_resolved_how_is_reference_picture_setup_requested_for_h_265_encode_operations)
