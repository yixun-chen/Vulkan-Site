...
- [5. Issues](#_issues)
- [5.1. RESOLVED: What is within the scope of this extension?](#_resolved_what_is_within_the_scope_of_this_extension)
- [5.1._RESOLVED:_What_is_within_the_scope_of_this_extension?](#_resolved_what_is_within_the_scope_of_this_extension)
- [5.2. RESOLVED: Are Vulkan video profiles equivalent to the corresponding concepts of video compression standards?](#_resolved_are_vulkan_video_profiles_equivalent_to_the_corresponding_concepts_of_video_compression_standards)
- [5.2._RESOLVED:_Are_Vulkan_video_profiles_equivalent_to_the_corresponding_concepts_of_video_compression_standards?](#_resolved_are_vulkan_video_profiles_equivalent_to_the_corresponding_concepts_of_video_compression_standards)
- [5.3. RESOLVED: Do we need a query to be able to enumerate all supported video profiles?](#_resolved_do_we_need_a_query_to_be_able_to_enumerate_all_supported_video_profiles)
- [5.3._RESOLVED:_Do_we_need_a_query_to_be_able_to_enumerate_all_supported_video_profiles?](#_resolved_do_we_need_a_query_to_be_able_to_enumerate_all_supported_video_profiles)
- [5.4. RESOLVED: Do we need queries that allow determining how multiple video profiles can be used in conjunction?](#_resolved_do_we_need_queries_that_allow_determining_how_multiple_video_profiles_can_be_used_in_conjunction)
- [5.4._RESOLVED:_Do_we_need_queries_that_allow_determining_how_multiple_video_profiles_can_be_used_in_conjunction?](#_resolved_do_we_need_queries_that_allow_determining_how_multiple_video_profiles_can_be_used_in_conjunction)
- [5.5. RESOLVED: What kind of capabilitity queries do we need?](#_resolved_what_kind_of_capabilitity_queries_do_we_need)
- [5.5._RESOLVED:_What_kind_of_capabilitity_queries_do_we_need?](#_resolved_what_kind_of_capabilitity_queries_do_we_need)
- [5.6. RESOLVED: What kind of command buffer commands do we need?](#_resolved_what_kind_of_command_buffer_commands_do_we_need)
- [5.6._RESOLVED:_What_kind_of_command_buffer_commands_do_we_need?](#_resolved_what_kind_of_command_buffer_commands_do_we_need)
- [5.7. RESOLVED: How can the application get feedback about the status of video coding operations?](#_resolved_how_can_the_application_get_feedback_about_the_status_of_video_coding_operations)
- [5.7._RESOLVED:_How_can_the_application_get_feedback_about_the_status_of_video_coding_operations?](#_resolved_how_can_the_application_get_feedback_about_the_status_of_video_coding_operations)
- [5.8. RESOLVED: Do we need to introduce new vkCmdBeginQueryRangeKHR and vkCmdEndQueryRangeKHR commands to allow capturing feedback about multiple video coding operations using a single scope?](#_resolved_do_we_need_to_introduce_new_vkcmdbeginqueryrangekhr_and_vkcmdendqueryrangekhr_commands_to_allow_capturing_feedback_about_multiple_video_coding_operations_using_a_single_scope)
- [5.8._RESOLVED:_Do_we_need_to_introduce_new_vkCmdBeginQueryRangeKHR_and_vkCmdEndQueryRangeKHR_commands_to_allow_capturing_feedback_about_multiple_video_coding_operations_using_a_single_scope?](#_resolved_do_we_need_to_introduce_new_vkcmdbeginqueryrangekhr_and_vkcmdendqueryrangekhr_commands_to_allow_capturing_feedback_about_multiple_video_coding_operations_using_a_single_scope)
- [5.9. RESOLVED: Can resources be shared across video sessions, potentially ones using different video profiles?](#_resolved_can_resources_be_shared_across_video_sessions_potentially_ones_using_different_video_profiles)
- [5.9._RESOLVED:_Can_resources_be_shared_across_video_sessions,_potentially_ones_using_different_video_profiles?](#_resolved_can_resources_be_shared_across_video_sessions_potentially_ones_using_different_video_profiles)
- [5.10. RESOLVED: How are video coding operations synchronized with respect to other Vulkan operations?](#_resolved_how_are_video_coding_operations_synchronized_with_respect_to_other_vulkan_operations)
- [5.10._RESOLVED:_How_are_video_coding_operations_synchronized_with_respect_to_other_Vulkan_operations?](#_resolved_how_are_video_coding_operations_synchronized_with_respect_to_other_vulkan_operations)
- [5.11. RESOLVED: Why do some of the members of VkVideoProfileInfoKHR have Flags types instead of FlagBits types when only a single bit can be used?](#_resolved_why_do_some_of_the_members_of_vkvideoprofileinfokhr_have_flags_types_instead_of_flagbits_types_when_only_a_single_bit_can_be_used)
- [5.11._RESOLVED:_Why_do_some_of_the_members_of_VkVideoProfileInfoKHR_have_Flags_types_instead_of_FlagBits_types_when_only_a_single_bit_can_be_used?](#_resolved_why_do_some_of_the_members_of_vkvideoprofileinfokhr_have_flags_types_instead_of_flagbits_types_when_only_a_single_bit_can_be_used)
- [5.12. RESOLVED: Can the application create video sessions with any maxDpbSlots and maxActiveReferencePictures values within the supported capabilities?](#_resolved_can_the_application_create_video_sessions_with_any_maxdpbslots_and_maxactivereferencepictures_values_within_the_supported_capabilities)
- [5.12._RESOLVED:_Can_the_application_create_video_sessions_with_any_maxDpbSlots_and_maxActiveReferencePictures_values_within_the_supported_capabilities?](#_resolved_can_the_application_create_video_sessions_with_any_maxdpbslots_and_maxactivereferencepictures_values_within_the_supported_capabilities)
- [5.13. RESOLVED: Are VkVideoSessionParametersKHR objects internally or externally synchronized?](#_resolved_are_vkvideosessionparameterskhr_objects_internally_or_externally_synchronized)
- [5.13._RESOLVED:_Are_VkVideoSessionParametersKHR_objects_internally_or_externally_synchronized?](#_resolved_are_vkvideosessionparameterskhr_objects_internally_or_externally_synchronized)
