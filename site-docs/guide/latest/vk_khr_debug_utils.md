...
- **Component**: guide
- **Version**: latest
- **URL**: /guide/latest/extensions/VK_KHR_debug_utils.html
...
- [Using Debugging Tools with VK_KHR_debug_utils](#_using_debugging_tools_with_vk_khr_debug_utils)
- [Using_Debugging_Tools_with_VK_KHR_debug_utils](#_using_debugging_tools_with_vk_khr_debug_utils)
...
- [Migrating from VK_EXT_debug_report to VK_KHR_debug_utils](#_migrating_from_vk_ext_debug_report_to_vk_khr_debug_utils)
- [Migrating_from_VK_EXT_debug_report_to_VK_KHR_debug_utils](#_migrating_from_vk_ext_debug_report_to_vk_khr_debug_utils)
